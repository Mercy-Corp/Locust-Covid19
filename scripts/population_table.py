...
class PopulationTable:
    ...
    def __init__(self, path_in = INPUT_PATH, path_out = OUTPUT_PATH):
        ...
        self.shapefile_table = gpd.read_file(self.path_out + "shape_boundary/shapefile_table.shp")
...
if __name__ == '__main__':
    ...
    print(OUTPUT_PATH + 'population_fact/population_table_2015')

    # Export
    FlatFiles().export_output(population_df, 'population_fact/population_table_2015')
