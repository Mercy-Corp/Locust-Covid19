...
class ProductionTable:
    ...
    def __init__(self, path_in = INPUT_PATH, path_out = OUTPUT_PATH):
        ...
        self.locations = pd.read_csv(self.path_out + "location_dim/location_table.csv", sep = "|")[['locationID', 'name']]
...
if __name__ == '__main__':
    ...
    # Export
    FlatFiles().export_output_w_date(production_df, 'production_fact/production_table')
