...
Created on Fri Jul 03 19:35:40 2020
...
class PopulationTable:
    ...
    def __init__(self, INPUT_PATH, OUTPUT_PATH):
        ...
        self.raster_Uganda = self.path_in + "population/uga_ppp_2020_UNadj.tif"
        self.raster_Kenya = self.path_in + "population/ken_ppp_2020_UNadj.tif"
        self.raster_Somalia = self.path_in + "population/som_ppp_2020_UNadj.tif"
        self.raster_Ethiopia = self.path_in + "population/eth_ppp_2020_UNadj.tif"
...
if __name__ == '__main__':
    ...
    # Export
    pop_table.export_to_parquet(population_df, 'population_table_2020')
    pop_table.export_to_csv(population_df, 'population_table_2020')